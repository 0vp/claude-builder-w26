                ...
                >
                    ...
                    <div className="mb-5">
                        ...
                        <input
                            ...
                            className={`w-full rounded-xl border px-4 py-3 text-white bg-white/10 placeholder-rose-300/40 outline-none transition focus:ring-2 ${nameError
                    ...
                    <div className="mb-7">
                        ...
                        <textarea
                            ...
                            className={`w-full rounded-xl border px-4 py-3 text-white bg-white/10 placeholder-rose-300/40 outline-none transition focus:ring-2 ${interestsError
                                    ? 'border-red-400 focus:ring-red-400/40'
                                    : 'border-rose-700/50 focus:border-pink-500 focus:ring-pink-500/30'
                                }`}
                        />
